...
const SiedelIterationBox = ({ coefficients, initialValues, numOfIterations, presicion }) => {
    const [iterationValues, setIterationValues] = useState([]);
    ...
    for (let i = 0; i < numOfIterations; i++) {
        ...
        setIterationValues(prevValues => [...prevValues, { x, y, z }]);
        ...
        <MathJax>
            <div>
                <h3 className="mt-6 mb-2">
                    Initially, x<sub>0</sub> = {initialValues[0]}, y<sub>0</sub> = {initialValues[1]}, z<sub>0</sub> = {initialValues[2]}
                </h3>
                {iterations}
            </div>
...
export default SiedelIterationBox;
