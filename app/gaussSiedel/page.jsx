...
import SiedelIterationBox from "@/components/SiedelIterationBox";
import { motion } from "framer-motion";

const GaussSiedel = () => {
  useEffect(() => {
    document.title = "Gauss Siedel";
  }, []);
  ...
  return (
    <>
      <div className="main pt-4 pb-1 mx-10 rounded-b-[3rem]">
        <h1 className="text-right text-6xl font-medium space text-[#ffffff8c] mr-6 mb-2">Gauss Siedel</h1>
